...
export const ChatSidebar: React.FC<ChatSidebarProps> = ({
  ...
  const sidebarContent = (
    <div className="w-full lg:w-64 h-full flex flex-col shrink-0 min-w-0 bg-[#0e0f12] text-[#edeef2] border-r border-[#1f222b] select-none font-['Plus_Jakarta_Sans',sans-serif]">
      {/* Brand Header */}
      <div className="p-3 pb-2.5 flex items-center justify-between border-b border-[#1f222b]">
        <div className="flex items-center gap-2.5">
          <img
            src={SAPPHIRE_LOGO_URL}
            alt="Sapphire"
            className="w-7 h-7 rounded-xl object-cover ring-1 ring-blue-500/30 shadow-xs"
          />
          <div className="flex flex-col">
            <span className="font-semibold text-xs text-[#f3f4f6] tracking-tight">Sapphire</span>
            <span className="text-[10px] text-[#717684] leading-none">Studio</span>
          </div>
        </div>
      ...
      <div className="p-3 space-y-1.5">
        ...
        <button
          ...
          className="w-full py-2 px-3 bg-[#18191e] hover:bg-[#22242c] text-[#edeef2] rounded-xl text-xs font-medium flex items-center gap-2 transition-all border border-[#272a33] active:scale-[0.99] cursor-pointer"
        >
        ...
        <button
          ...
          className={`w-full py-1.5 px-2.5 rounded-xl text-xs font-normal flex items-center justify-between transition-colors cursor-pointer ${
            activeNavTab === 'customize'
              ? 'bg-[#1e2027] text-white font-medium'
              : 'text-[#9ca3af] hover:bg-[#18191e] hover:text-[#edeef2]'
          }`}
          title="Customize"
        >
          <div className="flex items-center gap-2.5">
      ...
      <div className="p-3 border-t border-[#1f222b] flex items-center justify-between gap-2 shrink-0">
        <button
          type="button"
          onClick={() => {
        ...
        >
          ...
          <div className="w-6 h-6 rounded-lg bg-[#1e2027] border border-[#272a33] text-[#edeef2] flex items-center justify-center text-[11px] font-semibold shrink-0">
            {initial.toUpperCase()}
          </div>
          <div className="min-w-0 flex items-center gap-1.5 text-xs text-[#edeef2] truncate">
            <span className="truncate font-medium">{userName}</span>
            <ChevronDown className="w-3 h-3 text-[#717684] shrink-0" />
          </div>
        </button>
